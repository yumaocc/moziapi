...
func ProvideSettingHandler(settingService *service.SettingService, pricingService *service.PricingService, buildInfo BuildInfo, notificationEmailService *service.NotificationEmailService) *SettingHandler {
