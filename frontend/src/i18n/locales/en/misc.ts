export default {
  ...
  payment: {
    ...
    rechargeAmountUsd: 'Recharge Amount (USD)',
    gatewaySettlement: 'Order Amount',
    usdToCnySettlementHint: 'Payment is converted at 1 USD = {rate} CNY; account balances remain in USD',
    creditedBalance: 'Credited Balance',
    promotionalGift: 'Bonus Credit',
    ...
    orders: {
      ...
      orderNo: 'Order No.',
      amount: 'Amount',
      requestedAmount: 'Recharge Amount (USD)',
      payAmount: 'Paid',
    ...
    rechargeRatePreview: 'Current credit multiplier: ×{multiplier}',
    ...
    admin: {
      ...
      currencyHint: 'Plan prices and account balances use USD; CNY gateways convert automatically at settlement',
