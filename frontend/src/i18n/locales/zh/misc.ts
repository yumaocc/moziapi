export default {
  ...
  payment: {
    ...
    amountLabel: '充值金额',
    paymentAmount: '支付金额',
    rechargeAmountUsd: '充值金额（USD）',
    gatewaySettlement: '订单金额',
    usdToCnySettlementHint: '支付时按 1 USD = {rate} CNY 自动换算，账户金额始终以 USD 计算',
    creditedBalance: '到账余额',
    promotionalGift: '活动赠送',
    quickAmounts: '快捷金额',
    customAmount: '自定义金额',
    enterAmount: '输入金额',
    paymentMethod: '支付方式',
    ...
    rechargeRatePreview: '当前到账倍率：×{multiplier}',
    refundReason: '退款原因',
    ...
    admin: {
      ...
      currencyHint: '套餐价格和账户金额统一使用 USD；CNY 支付通道会在结算时自动换算',
